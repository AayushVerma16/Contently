      ...
      <section className="relative z-10 mt-48 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="space-y-6 sm:space-y-8 text-center lg:text-left">
            ...
            {/* Centered buttons responsively */}
            <div className="flex flex-col sm:flex-row gap-4 w-full items-center justify-center sm:items-center sm:justify-start lg:items-start">
              <Link href="/dashboard" className="w-full sm:w-auto flex justify-center">
                <Button
                  size="xl"
                  variant="primary"
                  className="rounded-full w-full sm:w-auto text-white min-w-[200px] sm:min-w-[180px] px-6 sm:px-8"
                >
                  <span className="flex-1">Start Creating for Free</span>
                  <ArrowRight className="h-4 w-4 ml-2" />
                </Button>
              </Link>
              <Link href="/feed" className="w-full sm:w-auto flex justify-center">
                <Button
                  variant="outline"
                  size="xl"
                  className="rounded-full w-full sm:w-auto min-w-[200px] sm:min-w-[180px] px-6 sm:px-8"
                >
                  <span className="flex-1">Explore the Feed</span>
                </Button>
              </Link>
            </div>
