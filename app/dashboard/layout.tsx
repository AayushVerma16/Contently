        ...
        <nav className="p-4 space-y-2">
          {sidebarItems.map((item, index) => {
            ...
            return (
              ...
              >
                <div
                  // The "cn" function (short for "classnames") is used here to conditionally join CSS class names together based on whether the sidebar item is active.
                  // This makes it easier to manage Tailwind and conditional classes in a readable way.
                  className={cn(
