...
export default function DashboardPage() {
  ...
  // Determine post display status
  const getPostStatus = (post: any) => {
    if (post.status === "published") {
      return { label: "published", color: "green" };
    } else if (post.scheduledFor && post.scheduledFor > Date.now()) {
                      ...
                      >
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-4 mt-2">
                            <Badge
                              variant={
                                postStatus.label === "published"
                                  ? "default"
                                  : "outline"
                              }
                              className={
                                postStatus.color === "green"
                                  ? "bg-green-500/20 text-green-300 border-green-500/30"
                                  : postStatus.color === "blue"
                                    ? "bg-blue-500/20 text-blue-300 border-blue-500/30"
                                    : "bg-orange-500/20 text-orange-300 border-orange-500/30"
                              }
                            >
                              {postStatus.label === "scheduled" && (
