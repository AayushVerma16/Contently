...
interface PostCardProps {
  ...
  showActions?: boolean;
  showAuthor?: boolean;
  onEdit?: (post: any) => void;  // Added post parameter
  onDelete?: (post: any) => void;  // Added post parameter
  onDuplicate?: (post: any) => void;  // Added post parameter
  className?: string;
}
          ...
          <div className="flex items-start justify-between mt-5">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-2">
                <Badge
                  variant={statusBadge.variant as "secondary" | "default" | "outline" | "destructive" | null | undefined}
